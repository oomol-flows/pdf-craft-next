...
def main(params: Inputs, context: Context) -> Outputs:
    ...
    def on_ocr_event(event):
        ...
        if kind == OCREventKind.START:
            ...
            print(f"[PDF-to-Markdown] Page {current_page}/{total_pages} skipped (cached) - {progress:.1f}%")
            ...
            print(f"[PDF-to-Markdown] Page {current_page}/{total_pages} ignored - {progress:.1f}%")
            ...
            print(f"[PDF-to-Markdown] Page {current_page}/{total_pages} completed in {cost_time:.2f}s - {progress:.1f}%")
